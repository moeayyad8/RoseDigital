...
function SimpleMenu() {
  ...
  <div class="h-screen sticky top-0 px-4 py-6">
    <span class="block  w-32 h-10 bg-gray-200 rounded-lg"><Navbar/></span>

    <nav class="flex flex-col mt-6 space-y-1">
      <a
        href="/Order"
        class="flex items-center px-4 py-2 text-gray-700 bg-yellow-500 rounded-lg "
      >
        <svg
        ...
        <span class="ml-3 text-sm font-medium"> Order Now </span>
      </a>
      ...
      <details class="group">
        ...
        >
          ...
          <span class="ml-3 text-sm font-medium"> Content </span>
        ...
        <nav class="mt-1.5 ml-8 flex flex-col">
          ...
          >
            ...
            <span class="ml-3 text-sm font-medium"> Scripts </span>
          </a>
          ...
          >
            ...
            <span class="ml-3 text-sm font-medium"> Talent </span>
          </a>
        </nav>
      </details>
